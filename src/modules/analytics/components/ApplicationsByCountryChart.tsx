...
export function ApplicationsByCountryChart({ data }: ApplicationsByCountryChartProps) {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Applications by Country</CardTitle>
        <CardDescription>Total applications from each country in the selected period.</CardDescription>
      </CardHeader>
      <CardContent>
