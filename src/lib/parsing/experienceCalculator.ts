import { ParsedWorkExperience } from "@/lib/types";
...
export function extractExperience(text: string): { workExperience: ParsedWorkExperience[], totalExperienceMonths: number } {
