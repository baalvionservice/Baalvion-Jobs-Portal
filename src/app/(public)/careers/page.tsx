...
import { CheckCircle, Globe, Rocket, Users, Zap, Building, ChevronRight, Star, Search, Users2, Target } from "lucide-react";
...
export async function generateMetadata(): Promise<Metadata> {
  const title = "Careers at Baalvion | Build Global Infrastructure";
  const description = "Join Baalvion, headquartered in India with a globally distributed workforce. We're building the intelligent infrastructure that connects exceptional talent with borderless opportunity.";
  const canonicalUrl = `${AppConfig.baseUrl}/careers`;
...
const whyJoinUsItems = [
    { icon: <Rocket className="h-8 w-8 text-primary" />, title: "Drive Innovation", description: "Work on challenging problems and build the future of global hiring with cutting-edge technology." },
    { icon: <Globe className="h-8 w-8 text-primary" />, title: "Global Impact", description: "Be part of a diverse, global team that’s making talent acquisition borderless and more equitable." },
    { icon: <Users className="h-8 w-8 text-primary" />, title: "Full Ownership", description: "We believe in empowering our team. Take ownership of your projects from idea to deployment." },
    { icon: <Zap className="h-8 w-8 text-primary" />, title: "Accelerated Growth", description: "We invest in your development with a generous learning budget and opportunities for advancement." },
];
            ...
            <section className="relative h-[60vh] min-h-[450px] w-full flex items-center justify-center text-center text-white">
                ...
                <div className="relative container mx-auto px-4">
                    ...
                    <p className="mt-4 max-w-3xl mx-auto text-lg md:text-xl text-neutral-200">
                        The Operating System for Global Talent.
                    </p>
             ...
             <section className="py-24 lg:py-32 bg-muted/50">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
                        Building global infrastructure from India to the world.
                    </p>
                    <div className="mt-8">
                        <Button size="lg" asChild>
            ...
            <section className="py-24 lg:py-32">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto">
                        ...
                        <p className="mt-4 text-lg text-muted-foreground">We are a team of builders, thinkers, and innovators on a mission to unlock the world's human potential.</p>
                    </div>
                    <div className="mt-16 grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                        {whyJoinUsItems.map(item => (
                             <div key={item.title} className="text-center p-6 border border-transparent hover:bg-card hover:border-border rounded-lg transition-all">
                                {item.icon}
            ...
            <section id="global-presence" className="py-24 lg:py-32 bg-muted/50">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto">
                        ...
                        <p className="mt-4 text-lg text-muted-foreground">Baalvion is headquartered in India with a globally distributed workforce across North America, Europe, and Asia-Pacific.</p>
                    </div>
                                        ...
                                        <div className="flex justify-between items-start">
                                            <div>
                                                ...
                                                {country.type === 'headquarters' ? (
                                                    ...
                                                    <p className="text-sm text-muted-foreground">{country.hiringModel.replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase())} Region</p>
                                                )}
                                            </div>
