        ...
        <main className="bg-background text-foreground">
             <section className="py-24 sm:py-32 bg-muted/30">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-5xl md:text-6xl font-bold tracking-tight">Full-Time Roles</h1>
                    <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
                        Build your career with us. Explore full-time opportunities to make a lasting impact on a global scale.
                    </p>
                </div>
            </section>
                    ...
                    {jobs.length > 0 ? (
                        ...
                        <Card>
                            <CardContent className="p-12 text-center">
                                <h3 className="text-xl font-semibold">No Full-Time Positions Available Currently</h3>
