...
export default function CampusReportsPage() {
    ...
    return (
        <div className="flex flex-col gap-8">
            <div>
                <h1 className="text-3xl font-bold tracking-tight">Campus Placement Analytics</h1>
                <p className="text-muted-foreground">Visualize campus recruitment data and performance metrics.</p>
            </div>
            ...
            {isLoading || !data ? (
                ...
                <div className="space-y-8">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <PlacementSuccessPie rate={Number(data?.placementSuccessRate) || 0} />
